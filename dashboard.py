...
with tab1:
    ...
    textfont=dict(color='#2C3E50', size=12)
                ...
                fig_bar.update_xaxes(showgrid=False, tickfont=dict(color='#2C3E50', size=11))
                fig_bar.update_yaxes(showgrid=True, tickfont=dict(color='#2C3E50', size=11, gridcolor='rgba(255,224,236,0.5)')
